...
measure_state.json: checked_at=2026-07-23T07:41:15.475099+00:00, mu=568.6, rank=3664, submission_count=2
episode datasets scanned since None: [] (not yet published: [], failed: [])
episodes found per day: {'2026-07-23': 8, '2026-07-22': 67}

## Parse summary
parsed OK: 75  |  not-ours (unexpected if >0): 0  |  failed to parse: 0
...
game 87435268 vs AibePC: 54 logged decisions, terminal={'our_status': 'DONE', 'our_deck_count': 44, 'opp_deck_count': 33, 'our_prizes_remaining': 5, 'opp_prizes_remaining': 5, 'our_active_present': True, 'our_bench_count': 0}
    [game 87435268 seed None turn 4.4] mid-game decision in a other_attrition loss
      you_active: card=51 serial=69 hp=150/150 energies=[3, 3]
      opp_active: none
      - idx=0 card
      - idx=1 card
      - idx=2 card
      ...
      - idx=4 card
      - idx=5 card
game 87435806 vs nimous: 16 logged decisions, terminal={'our_status': 'DONE', 'our_deck_count': 45, 'opp_deck_count': 45, 'our_prizes_remaining': 6, 'opp_prizes_remaining': 6, 'our_active_present': True, 'our_bench_count': 0}
    [game 87435806 seed None turn 2.2] mid-game decision in a other_attrition loss
      ...
      - idx=1 attack
      - idx=2 end
game 87436356 vs naoki: 88 logged decisions, terminal={'our_status': 'DONE', 'our_deck_count': 43, 'opp_deck_count': 19, 'our_prizes_remaining': 2, 'opp_prizes_remaining': 6, 'our_active_present': True, 'our_bench_count': 0}
    [game 87436356 seed None turn 15.1] mid-game decision in a other_attrition loss
      you_active: card=180 serial=22 hp=80/110 energies=[3, 3, 3, 3, 3, 3, 3]
      opp_active: card=431 serial=85 hp=30/280 energies=[11, 11, 1]
      - idx=0 play card=105
      - idx=1 attach card=3 target=180(serial 22)
      - idx=2 play card=105
      - idx=3 attach card=3 target=180(serial 22)
      - idx=4 attack <== CHOSEN
      - idx=5 end

### Bucket: bench_wipe
game 87439590 vs naoteru nakamura: 40 logged decisions, terminal={'our_status': 'DONE', 'our_deck_count': 44, 'opp_deck_count': 25, 'our_prizes_remaining': 5, 'opp_prizes_remaining': 6, 'our_active_present': False, 'our_bench_count': 0}
    [game 87439590 seed None turn 4.1] mid-game decision in a bench_wipe loss
      you_active: card=105 serial=64 hp=40/70 energies=[3]
      opp_active: card=673 serial=16 hp=50/80 energies=[6, 6]
      - idx=0 evolve card=51 target=105(serial 64)
      - idx=1 attach card=3 target=105(serial 64) <== CHOSEN
      - idx=2 attach card=3 target=105(serial 64)
      - idx=3 attach card=3 target=105(serial 64)
      - idx=4 evolve card=51 target=105(serial 64)
      - idx=5 attach card=3 target=105(serial 64)
      - idx=6 attach card=3 target=105(serial 64)
      - idx=7 end
game 87442303 vs Vishwas Mishra: 64 logged decisions, terminal={'our_status': 'DONE', 'our_deck_count': 43, 'opp_deck_count': 19, 'our_prizes_remaining': 4, 'opp_prizes_remaining': 5, 'our_active_present': False, 'our_bench_count': 0}
    [game 87442303 seed None turn 3.4] mid-game decision in a bench_wipe loss
      ...
      - idx=4 card
      - idx=5 card
game 87482630 vs Zeina Shaltout: 119 logged decisions, terminal={'our_status': 'DONE', 'our_deck_count': 39, 'opp_deck_count': 11, 'our_prizes_remaining': 2, 'opp_prizes_remaining': 3, 'our_active_present': False, 'our_bench_count': 0}
    [game 87482630 seed None turn 9.3] mid-game decision in a bench_wipe loss
      you_active: card=180 serial=19 hp=110/110 energies=[3]
...
## (e) Secondary metrics
attack-decline rate (ladder losses): 554/714 (77.6%)
...
our current leaderboard score: 568.6
  vs stronger opponents: 23 games -- {'opponent_win': 18, 'candidate_win': 5}
  vs similar opponents: 23 games -- {'candidate_win': 13, 'opponent_win': 10}
  vs weaker opponents: 29 games -- {'opponent_win': 13, 'candidate_win': 16}
...
ladder attack-decline rate: 554/714 (77.6%)
